...
var AppComponent = (function () {
    ...
    AppComponent.prototype.onSubmit = function (firstName, lastName) {
        var _this = this;
    ...
    AppComponent.prototype.onGetUser = function () {
        ...
        this._firsbaseService
            .getUser()
            .subscribe(function (users) { return _this.response = JSON.stringify(users); }, function (error) { return console.log(error); });
    };
